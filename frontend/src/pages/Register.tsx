...
export default function Register() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg">
      ...
      <input type="text" value={username} onChange={e => setUsername(e.target.value)} placeholder="Ім'я" className="w-full p-2 mb-3 border rounded" />
      ...
      <button type="submit" className="w-full p-2 bg-green-600 text-white rounded">Зареєструватися</button>
    </form>
  )
}
